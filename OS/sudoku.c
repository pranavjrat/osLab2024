...
int main(void) 
{
   ...
   if (all_rows == NULL || all_cols == NULL || square1 == NULL ||
    square2 == NULL || square3 == NULL || square4 == NULL ||
    square5 == NULL || square6 == NULL || square7 == NULL ||
    square8 == NULL || square9 == NULL) {
    printf("There was an error in thread execution.\n");
} else {
    // Check if all threads returned 1
    if ((int)all_rows == 1 && (int)all_cols == 1 && (int)square1 == 1 &&
